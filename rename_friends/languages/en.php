...
$english = array(
	...
	'friends:collections' => "{$usingle} collections",
	'friends:collections:add' => "New {$lplural} collection",
	'friends:addfriends' => "Select {$lplural}",
	'friends:collectionfriends' => "{$uplural} in collection",
...
You cannot reply to this email.",
	...
	'extendafriend:updated' => "{$usingle} access collections have been updated",
